...
const words = computed(() => {
    const paraStr = 'We are a full-service interior design firm that specializes in crafting unique, personalized, and curated interiors, catering to clients all across the U.S. Our signature style revolves around creating bold concepts infused with both glamour and warmth, seamlessly blending the charm of the past with a passion for contemporary design.';
            ...
            <div class="pk__about_image-container">
                ...
                <div class="pk__about_image-wrap wrap-2" ref="aboutImageWrap2Ref">
                    <figure class="pk__about_image" ref="aboutImage2Ref">
                        <img :src="image2" style="object-position: 60% 50%;" loading="lazy">
                    </figure>
                </div>
            </div>
